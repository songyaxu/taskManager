            ...
            <div class="span3">
                ...
                <ul id="settings-menu" class="nav nav-list collapse in">
                  ...
                  <s:if test="#session.user.type!=0">
	                  ...
	                  <s:if test="#session.user.type==2">
	                  <li class="active"><a href="${pageContext.request.contextPath}/cr/add.jsp">发布课堂</a></li>
	                  </s:if>
	              </s:if>
                </ul>
...
<div class="well">
    ...
    <form id="tab">
        ...
        <label>资源链接<font style="color:red;">(视频资源链接等)</font></label>
