...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function add(){
			$.post("adminservice!add.action",{'admin.no':$("#no").val(),'admin.name':$("#name").val(),'admin.pwd':$("#pwd").val()},function(result){
        ...
        <div class="row-fluid">
            <div class="span3">
                ...
                <ul id="account-menu" class="nav nav-list collapse in">
                  <s:if test="#session.user.type==3">
                  	<li class="active"><a href="${pageContext.request.contextPath}/admin/addadmin.jsp">增加管理员</a></li>
