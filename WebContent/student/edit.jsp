...
<html>
  <head>
	...
	<script type="text/javascript">
		function update(){
			$.post("studentservice!update.action",{'id':$("#id").val(),'student.pwd':$("#pwd").val(),'student.no':$("#no").val()},function(result){
...
<div class="well">
    ...
    <form id="tab">
    	<input type="hidden" id="id" value="<s:property value="#request.student.id" />">
        <label>学号</label>
        <input type="text" class="input-xlarge" name="no" id="no"  disabled="true" value="<s:property value="#request.student.no" />" >
        <label>姓名</label>
        <input type="text" class="input-xlarge" name="name" id="name" disabled="true" value="<s:property value="#request.student.name" />" >
        <label>密码</label>
        <input type="password" class="input-xlarge" name="pwd" id="pwd" value="">
    </form>
      </div>
  </div>
