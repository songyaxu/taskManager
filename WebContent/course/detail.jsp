<%@page import="com.taskmanager.entity.Course"%>
...
<div class="well" style="min-height:500px;">
    ...
    <p style="text-align:right;">--------指导教师:${course.teacherName}</p>
	<hr>
	<p>
		课程性质：${course.style} &nbsp;&nbsp;&nbsp;&nbsp;课程内容：${course.content}
	</p>
	<p>
		
	</p>
	<hr>
	<h3 style="text-align:center;">教学大纲</h3>
    <% out.println(((Course)request.getAttribute("course")).getOutline());%>
    <p>
    </p>
</div>
