        ...
        <div class="row-fluid">
            <div class="span3">
                ...
                <ul id="accounts-menu" class="nav nav-list collapse in">
                  <li class="active"><a href="scancourse">课程浏览</a></li>
...
<div class="well">
    <table class="table">
      ...
      <tbody>
      	<s:iterator value="#session.courses" id="infos">
      		<tr>
	      		<td><%=++i%></td>
	      		<td><s:property value="#infos.no" /></td>
	      		<td><a href="courseservice!detail.action?id=<s:property value="#infos.id" />"><s:property value="#infos.name" /></a></td>
    ...
    <div class="block-body">
                <div class="row-fluid" style="text-align: center;">
                    <div class="pull-left span4 unstyled">
                        <p>总记录数:<s:property value="coursePage.totalCount" /></p>
                    </div>
                    <div class="pull-left span4 unstyled">
                        <p>每页记录数：<s:property value="coursePage.everyPage" /></p>
                    </div>
                    <div>
                        <p>总页数：<s:property value="coursePage.totalPage" /></p>
                    </div>
                    </div>
    ...
    <ul>
		...
		<li><a href="scaninfo!frontPage.action?currentPage=<s:property value="coursePage.currentPage" />&style=1" class="btu">上一页</a></li>
		</s:if>
		<li><a href="#" style="color:#000;"><s:property value="coursePage.currentPage" /></a></li>
		<s:if test="#request.coursePage.currentPage+1<=#request.coursePage.totalPage">
		<li><a href="scaninfo!nextPage.action?currentPage=<s:property value="coursePage.currentPage" />&style=1" class="btu"><s:property value="coursePage.currentPage+1" /></a></li>
		</s:if>
		<s:if test="#request.coursePage.currentPage+2<=#request.coursePage.totalPage">
		<li><a href="scaninfo!nextPage.action?currentPage=<s:property value="coursePage.currentPage+1" />&style=1" class="btu"><s:property value="coursePage.currentPage+2" /></a></li>
		</s:if>
		<s:if test="#request.coursePage.currentPage+3<=#request.coursePage.totalPage">
		<li><a href="scaninfo!nextPage.action?currentPage=<s:property value="coursePage.currentPage+2" />&style=1" class="btu"><s:property value="coursePage.currentPage+3" /></a></li>
		</s:if>
		<s:if test="#request.coursePage.hasNextPage==true">
		<li><a href="scaninfo!nextPage.action?currentPage=<s:property value="coursePage.currentPage" />&style=1" class="btu">下一页</a></li>
		</s:if>
	</ul>
</div>
